...
from quant_signals import RegimeFilter, MultiFactorAlpha, KalmanEntryTimer
...
def optimise_regime_weights(prices, volumes, timestamps):
    """
    SETO V9.5: Regime-Specific Optimization.
...
def main():
    print("\n" + "="*70)
    print("  SETO V9.5 — REGIME-SPECIFIC CENTURY TRAINING (100Y)")
    ...
    print("\n" + "="*70)
    print(f"✅ Training Complete. Files updated:")

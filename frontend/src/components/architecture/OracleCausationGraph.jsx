...
/** 🌀 Dhatu Oracle Causation Map V3.0 — 3-column HTML layout, large readable cards */
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.55rem', color: 'var(--dim)', fontFamily: 'JetBrains Mono' }}>
              CAUSAL INFERENCE ENGINE · SETO V8.5
            </div>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          {INPUT_NODES.map((node, i) => {
            // V3.1: Strict Data Integrity — Removing fake index-based 'activity' pulses.

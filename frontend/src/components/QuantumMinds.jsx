...
/** 🧠 SOVEREIGN COGNITIVE MATRIX v1.0-beta-beta | REAL-TIME MIND LAYER */
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span className="font-mono c-violet fw-900" style={{ fontSize: '0.5rem', letterSpacing: '-0.02em' }}>v1.0-beta-beta</span>
      </div>

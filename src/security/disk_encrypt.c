...
void aes_128_key_expand(const uint8_t* user_key, __m128i* key_schedule) {
...
void aes_ni_encrypt_block(const __m128i* plaintext, const __m128i* key_schedule, __m128i* ciphertext) {

...
# Project Path — Semantic Resolution (SETO V11.5 Upgrade)
...
# FTMO Limits / HFT Scaling Limits (SETO V8.0 Institutional Standards)
# ═══════════════════════════════════════════════════════════════════
...
# --- GAP-198: SCANNER FREQUENCY (SETO V23.1) ---
...
# QuestDB (SETO V22.5: Fast Fallback Configuration)
...
# --- GAP-177: CONFIG VALIDATION (SETO V23.1) ---

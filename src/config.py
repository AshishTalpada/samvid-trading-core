...
# Project Path — Semantic Resolution (Samvid v1.0-beta-beta Upgrade)
...
# THE CLOUD SINGULARITY: Platform-Aware Binary Scents
...
# Hard-unlocked to False for Active Paper Deployment.
...
# FTMO Limits / HFT Scaling Limits (Samvid v1.0-beta-beta Institutional Standards)
# ═══════════════════════════════════════════════════════════════════
...
# Instruments
# Specialized Instruments (High-Alpha Discipline)
...
# GAP-154: Currency Conversion (Static Fallback for Institutional Alignment)
...
# --- GAP-198: SCANNER FREQUENCY (Samvid v1.0-beta-beta) ---
...
# QuestDB (Samvid v1.0-beta-beta: Fast Fallback Configuration)
...
# --- GAP-177: CONFIG VALIDATION (Samvid v1.0-beta-beta) ---

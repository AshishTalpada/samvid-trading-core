"""
src/sovereign_decision_engine.py - The Singular Decision Point (Samvid v1.0-beta)
==========================================================================
...
class SovereignDecisionEngine:
    ...
    async def _evaluate_logic(self, context: Dict[str, Any], agent_outputs: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for agent, out in output_map.items():
            # Runtime Type Integrity Check (Samvid v1.0-beta: Added ABSTAIN support - GAP-06)
            vote = out.get("vote")
            ...
            # GAP-13 FIX: Throttling Lagging Agents instead of Sync Veto
            ...
            if vote == "YES":
                ...
                abstain_votes += 1
                continue # GAP-15: Skip confidence aggregation for abstentions

            total_confidence += out["confidence"]

        # --- BUG #11 FIX: Confidence Leak Protection ---
        ...
        # --- BREAKTHROUGH: STOP-RUN SHIELD (Samvid v1.0-beta Phantasm) ---

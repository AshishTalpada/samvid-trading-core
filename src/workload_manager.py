...
class WorkloadManager:
    """
    Persistent Mission Mission Board.
    ...
    def load(self) -> None:
        """Thread-safe mission board recovery from disk."""
        with self._lock:
            try:
    ...
    def save(self) -> None:
        """Atomically write mission board to disk via temp file swap."""
        with self._lock:
            try:
    ...
    async def complete_step(self, step_id: int) -> None:
        """Mark a granular mission step as completed."""

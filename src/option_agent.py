...
class OptionAgent:
    ...
    def predict_squeeze(self, spot_price: float, option_chain: list[dict]) -> dict:
        ...
        for opt in option_chain:
            ...
            total_dealer_gamma += (
                gamma_per_contract * opt["open_interest"] * 100 * position_multiplier
            )
        ...
        return {
            ...
            "hedging_flow_estimate": -total_dealer_gamma
            * 0.01,  # Rough estimate of shares needed to delta hedge a 1% move
        }

-- Migration 0001: Create core trading system schema (baseline)
-- Derived from data/schema.sql (Trading System V3.0, SETO V35.3)
...
CREATE INDEX IF NOT EXISTS idx_signals_symbol_time ON signals(instrument, timestamp);
